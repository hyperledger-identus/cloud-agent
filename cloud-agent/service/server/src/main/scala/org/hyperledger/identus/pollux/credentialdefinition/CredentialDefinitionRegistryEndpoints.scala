...
object CredentialDefinitionRegistryEndpoints {
  ...
  private val tagDescription =
    s"""
      ...
      |
      |A credential definition is generated by the issuer before any credential issuances and published for anyone (primarily holders and verifiers) to use.
      ...
      |
      |Most endpoints are secured by __apiKeyAuth__ or __jwtAuth__ authentication; some are public and require no authentication.
      |""".stripMargin

  private val tagExternalDocumentation = ExternalDocumentation(
    url = "https://hyperledger-identus.github.io/docs/category/credential-definition/",
  ...
  val getCredentialDefinitionByIdDidUrlEndpoint: PublicEndpoint[
    ...
    endpoint.get
      ...
      .description(
        "Fetch the credential definition by the unique identifier. It should have been created via DID URL, otherwise a not found error is returned."
      )
      .tag(tagName)
  ...
  val getCredentialDefinitionInnerDefinitionByIdHttpUrlEndpoint: PublicEndpoint[
    ...
    endpoint.get
      ...
      .out(jsonBody[zio.json.ast.Json].description("Inner definition of the credential definition found by `guid`"))
      .errorOut(basicFailuresAndNotFound)
      ...
      .description(
        "Fetch the inner definition field of the credential definition by the unique identifier"
      )
      .tag(tagName)
  ...
  val getCredentialDefinitionInnerDefinitionByIdDidUrlEndpoint: PublicEndpoint[
    ...
    endpoint.get
      ...
      .out(
        jsonBody[PrismEnvelopeResponse].description(
          "Inner definition of the credential definition found by `guid`, wrapped in an envelope"
        )
      )
      .errorOut(basicFailuresAndNotFound)
      ...
      .description(
        "Fetch the inner definition field of the credential definition by the unique identifier. It should have been created via DID URL, otherwise a not found error is returned."
      )
      .tag(tagName)
