package org.hyperledger.identus.didcomm.protocol.invitation.v1
import org.hyperledger.identus.didcomm.model.{AttachmentDescriptor, PIURI}
import org.hyperledger.identus.didcomm.model.AttachmentDescriptor.attachmentDescriptorEncoderV1
import org.hyperledger.identus.didcomm.protocol.invitation.ServiceType
...
final case class Invitation(
    `@id`: String = org.hyperledger.identus.didcomm.protocol.invitation.getNewMsgId,
    label: String,
    goal: String,
    goal_code: String,
    accept: Seq[String],
