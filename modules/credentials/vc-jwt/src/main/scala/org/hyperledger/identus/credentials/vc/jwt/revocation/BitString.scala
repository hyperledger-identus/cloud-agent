package org.hyperledger.identus.credentials.vc.jwt.revocation

import org.hyperledger.identus.credentials.vc.jwt.revocation.BitStringError.{DecodingError, EncodingError, IndexOutOfBounds}
