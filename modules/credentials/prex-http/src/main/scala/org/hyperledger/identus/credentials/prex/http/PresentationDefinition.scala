package org.hyperledger.identus.credentials.prex.http

import org.hyperledger.identus.credentials.prex.{ClaimFormat, InputDescriptor, PresentationDefinition}
import org.hyperledger.identus.credentials.prex.http.PresentationExchangeTapirSchemas.given
