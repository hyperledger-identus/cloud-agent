package org.hyperledger.identus.credentials.core.model.schema

import org.hyperledger.identus.credentials.core.model.error.CredentialSchemaError
import org.hyperledger.identus.credentials.core.model.error.CredentialSchemaError.CredentialSchemaValidationError
import org.hyperledger.identus.credentials.core.model.schema.`type`.{AnoncredSchemaType, CredentialJsonSchemaType}
import org.hyperledger.identus.credentials.core.model.schema.`type`.anoncred.AnoncredSchemaSerDesV1
import org.hyperledger.identus.credentials.core.model.schema.AnoncredSchemaTypeSpec.test
