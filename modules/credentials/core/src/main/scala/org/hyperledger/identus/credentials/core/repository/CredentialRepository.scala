...
import org.hyperledger.identus.credentials.anoncreds.AnoncredCredentialRequestMetadata
...
import org.hyperledger.identus.didcomm.protocol.issuecredential.{IssueCredential, RequestCredential}
