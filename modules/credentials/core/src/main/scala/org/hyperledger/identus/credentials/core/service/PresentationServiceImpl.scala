...
import org.hyperledger.identus.credentials.anoncreds.*
...
//This can be private remove
  ...
  override def createJwtPresentationRecord(
      ...
      options: Option[org.hyperledger.identus.credentials.core.model.presentation.Options],
  ...
  private def createPresentationFromIssuedCredential(
    ...
    val verifiableCredentials: Either[
      ...
      signedCredential
        .fromJson[org.hyperledger.identus.didcomm.model.Base64]
        .flatMap(x =>
      ...
      requestPresentation.attachments.headOption
        .map(attachment =>
          attachment.data.toJson
            ...
            .flatMap { base64 =>
              org.hyperledger.identus.credentials.core.service.serdes.SDJwtPresentation.given_JsonDecoder_SDJwtPresentation
  ...
  private def createJwtPresentationPayloadFromCredential(
    ...
    val maybePresentationOptions
        : Either[PresentationError, Option[org.hyperledger.identus.credentials.core.model.presentation.Options]] =
      requestPresentation.attachments.headOption
        .map(attachment =>
          attachment.data.toJson
            .fromJson[org.hyperledger.identus.didcomm.model.JsonData]
            .flatMap(data =>
