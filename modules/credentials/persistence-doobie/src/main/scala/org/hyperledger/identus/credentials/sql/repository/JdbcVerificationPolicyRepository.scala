...
import org.hyperledger.identus.credentials.core.model.{CredentialSchemaAndTrustedIssuersConstraint, VerificationPolicy}
import org.hyperledger.identus.credentials.core.repository.VerificationPolicyRepository
import org.hyperledger.identus.credentials.sql.model.db
...
class JdbcVerificationPolicyRepository(xa: Transactor[ContextAwareTask]) extends VerificationPolicyRepository {
  import org.hyperledger.identus.credentials.sql.model.db.VerificationPolicySql
