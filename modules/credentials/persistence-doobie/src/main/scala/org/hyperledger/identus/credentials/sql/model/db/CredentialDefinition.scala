package org.hyperledger.identus.credentials.sql.model.db

import io.getquill.*
import io.getquill.context.json.PostgresJsonExtensions
import io.getquill.doobie.DoobieContext
import io.getquill.idiom.*
import org.hyperledger.identus.credentials.core.model.schema.{CorrectnessProof, Definition}
...
object CredentialDefinition {
  def fromModel(
      m: org.hyperledger.identus.credentials.core.model.schema.CredentialDefinition,
      walletId: WalletId
  ...
  ): org.hyperledger.identus.credentials.core.model.schema.CredentialDefinition = {
    org.hyperledger.identus.credentials.core.model.schema.CredentialDefinition(
      guid = db.guid,
      id = db.id,
      name = db.name,
