...
import org.hyperledger.identus.did.core.model.did.{DIDData, PrismDID, PrismDIDOperation}
import org.hyperledger.identus.did.core.model.error.DIDResolutionError
import org.hyperledger.identus.did.core.util.{DIDOperationValidator, GenUtils}
import zio.*
import zio.test.*
