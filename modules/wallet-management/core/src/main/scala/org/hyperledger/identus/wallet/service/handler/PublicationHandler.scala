...
import org.hyperledger.identus.wallet.model.error.{CommonCryptographyError, CommonWalletStorageError}
import org.hyperledger.identus.wallet.model.ManagedDIDState
import org.hyperledger.identus.wallet.util.KeyResolver
import zio.*
