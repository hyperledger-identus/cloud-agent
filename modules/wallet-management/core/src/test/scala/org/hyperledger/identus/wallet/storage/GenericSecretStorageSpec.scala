...
import org.hyperledger.identus.wallet.vault.{VaultGenericSecretStorage, VaultWalletSecretStorage}
import zio.*
...
object GenericSecretStorageSpec
  ...
  final case class TestSecret(json: Json) // to be moved to credentials module?
