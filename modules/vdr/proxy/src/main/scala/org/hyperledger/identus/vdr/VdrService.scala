...
import org.hyperledger.identus.vdr.blockfrost.BlockfrostPrismDriverProvider
import org.hyperledger.identus.vdr.database.DatabaseDriverProvider
import org.hyperledger.identus.vdr.memory.MemoryDriverProvider
import org.hyperledger.identus.vdr.VdrConfigs.PRISMDriverConfig
import org.hyperledger.identus.vdr.VdrServiceError.{DeactivatedDid, DriverNotFound, MissingVdrKey, VdrEntryNotFound}
