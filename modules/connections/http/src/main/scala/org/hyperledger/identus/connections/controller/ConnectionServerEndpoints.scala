...
import org.hyperledger.identus.connections.controller.http.{AcceptConnectionInvitationRequest, CreateConnectionRequest}
...
class ConnectionServerEndpoints(
  ...
  val all: List[ZServerEndpoint[Any, Any]] = List(
    ...
    deleteConnectionServerEndpoint,
...
object ConnectionServerEndpoints {
  def all: URIO[ConnectionController & AuthenticatorWithAuthZ[BaseEntity], List[ZServerEndpoint[Any, Any]]] = {
    for {
