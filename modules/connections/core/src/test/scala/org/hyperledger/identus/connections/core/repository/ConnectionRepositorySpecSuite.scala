package org.hyperledger.identus.connections.core.repository

import org.hyperledger.identus.connections.core.model.{ConnectionRecord, ConnectionRecordBeforeStored}
...
object ConnectionRepositorySpecSuite {
  ...
  private def connectionRecord = ConnectionRecordBeforeStored(
    ...
    Invitation(
      ...
      body = Invitation
        .Body(
          goal_code = Some("org.hyperledger.identus.connections"),
  ...
  private def connectionRequest = ConnectionRequest(
    ...
    body = ConnectionRequest.Body(goal_code = Some("org.hyperledger.identus.connections"))
  )
