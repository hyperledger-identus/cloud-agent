...
import org.hyperledger.identus.credentials.core.model.oid4vci as oid4vciModel
...
object IssuerMetadata {
  ...
  def fromIssuer(
      ...
      issuer: oid4vciModel.CredentialIssuer,
      credentialConfigurations: Seq[oid4vciModel.CredentialConfiguration]
  ): IssuerMetadata = {
    IssuerMetadata(
...
object SupportedCredentialConfiguration {
  ...
  given Conversion[oid4vciModel.CredentialConfiguration, SupportedCredentialConfiguration] = cc =>
