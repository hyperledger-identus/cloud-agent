...
import org.hyperledger.identus.credentials.core.model.schema.CredentialDefinition.Input
import org.hyperledger.identus.credentials.credentialdefinition.http.CredentialDefinitionResponse.annotations
