...
import org.hyperledger.identus.credentials.core.repository.CredentialSchemaRepository
import org.hyperledger.identus.credentials.core.service.{CredentialSchemaService, CredentialSchemaServiceImpl}
import org.hyperledger.identus.credentials.credentialschema.controller.{
  CredentialSchemaController,
  CredentialSchemaControllerImpl
}
import org.hyperledger.identus.credentials.credentialschema.http.{
  CredentialSchemaInput,
  CredentialSchemaResponse,
  CredentialSchemaResponsePage
}
import org.hyperledger.identus.credentials.credentialschema.SchemaRegistryServerEndpoints
import org.hyperledger.identus.credentials.sql.repository.JdbcCredentialSchemaRepository
...
trait CredentialSchemaTestTools extends PostgresTestContainerSupport {
  ...
  def httpBackend(
    ...
    val schemaRegistryEndpoints =
      SchemaRegistryServerEndpoints(config.agent.httpEndpoint.serviceName, controller, authenticator, authenticator)
