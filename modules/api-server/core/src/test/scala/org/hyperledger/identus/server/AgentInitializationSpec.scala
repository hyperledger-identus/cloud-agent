...
import org.hyperledger.identus.server.config.{AppConfig, SecretStorageBackend}
...
import org.hyperledger.identus.wallet.service.{EntityServiceImpl, WalletManagementService, WalletManagementServiceImpl}
import org.hyperledger.identus.wallet.sql.{JdbcEntityRepository, JdbcWalletNonSecretStorage, JdbcWalletSecretStorage}
