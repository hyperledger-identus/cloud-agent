export default {
    ...
    plugins: [
        ...
        ["@semantic-release/exec", {
            "prepareCmd": "docker buildx build --platform=linux/arm64,linux/amd64 --push -t hyperledgeridentus/identus-cloud-agent:${nextRelease.version} ./cloud-agent/service/server/target/docker/stage"
        }],
        ["@semantic-release/exec", {
